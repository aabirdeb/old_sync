...
This tutorial teaches you some of the basic concepts in [aabirdeb Framework](https://aabirdeb.com). It is meant to be
...
- The URL to use is https://github.com/aabirdeb/addressbook.git
...
- To start the project, find the "Maven Projects" tab on the right hand side of the screen and navigate to
  - aabirdeb Web Application -> Plugins -> jetty -> jetty:run
...
- Team -> Git -> Clone
- Set repository URL to https://github.com/aabirdeb/addressbook.git
- Finish
- Right click the imported project (aabirdeb Addressbook Application) and select Run
...
- Set the repository URL to https://github.com/aabirdeb/addressbook.git
